...
const suits: {
  ...
  {
    title: "array",
    parameters: [[true, 42, { key: "foo" }], 100],
    expect: `[true,42,{"key":"foo"}]`,
  },
  {
    title: "array length",
    parameters: [[11, 22, 33], 4],
    expect: `[11]`,
  },
  {
    title: "array greedy",
    parameters: [[11, 22, 33], 5],
    expect: `[11,22]`,
  },
  {
    title: "object empty",
  ...
  {
    title: "object",
    parameters: [{ key: [true, 42, "foo"] }, 100],
    expect: `{"key":[true,42,"foo"]}`,
  },
  {
    title: "object length",
    parameters: [{ a: 1, b: 2, c: 3 }, 7],
    expect: `{"a":1}`,
  },
  {
    title: "object greedy",
    parameters: [{ a: 1, b: 2, c: 3 }, 8],
    expect: `{"a":1,"b":2}`,
  },
];
